    ...
    <div class="hero-body">
      <div class="container has-text-centered">
        <div class="column is-4 is-offset-4">
          <h3 class="title has-text-grey">新規登録</h3>
              ...
              <div class="field">
                <div class="control">
                  ...
                  <div v-if="$v.form.passwordConfirmation.$error" class="form-error">
                    ...
                    <span v-if="!$v.form.passwordConfirmation.sameAsPassword" class="help is-danger">Password Confirmation minimum length is 6 letters</span>
                  </div>
